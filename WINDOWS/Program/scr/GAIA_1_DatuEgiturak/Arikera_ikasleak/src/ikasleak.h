...
typedef enum {GEHITU_NOTA=1, BORRATU_NOTA, EGUNERATU_NOTA, BISTARATU_DANAK,BATAZBESTE_IKASLE_BAT, NOTA_ALTU_IKASLE, NOTA_BAXU_IKASLE, BILATU_IKASLE,BISTARATU_FINALA } MENUA;
