...
int ERABILTZAILEAK_sortu_(ERABILTZAILEA erabil[], int kop) {
	...
	strcpy(erabil[1].izena, "joseba");
	strcpy(erabil[1].password, "123");
	erabil[1].mota = EROSLE;
	erabil[1].dirua = 40;
	erabil[1].erosketak.zenbat = 0;
...
float ERABILTZAILEA_erosketakoPrezioa(ERABILTZAILEA erabiltzaileak[], int  kopErabil, int erabilIndex) {
