...
PELIKULA* zerrendaOsoaLiberatu(PELIKULA* lehena);
...
int main() {
	...
	ptrLehena = zerrendaOsoaLiberatu(ptrLehena);
	bistaratuPelikulenZerrenda(ptrLehena);
...
//Lehena-renbalorea funztioa honetan aldatzen denez , lehena-renbalore berria return-neatu behar dugu
PELIKULA* sartuBuruan(PELIKULA* lehena, PELIKULA* berria) {
...
void bistaratuPelikulenZerrenda(PELIKULA* ptr) {
	...
	if (ptr != NULL) {
		...
		printf("Ez dago pelikualrik zerredan!!!!!\n");
	}
