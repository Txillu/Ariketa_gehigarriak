...
void arruntaHobeututa(int zerrenda[], int kopurua);
...
int main() {
	...
	if (n == 1) {
		...
		t_hasiera = clock();
		arruntaHobeututa(zerrenda, kopurua);
		t_bukaera = clock();
		...
		t_hasiera = clock();
		arruntaHobeututa(zerrendaOrdenatuta, 30000);
		t_bukaera = clock();
		...
		t_hasiera = clock();
		arruntaHobeututa(zerrenda5, kopurua);
		t_bukaera = clock();
		...
		t_hasiera = clock();
		arruntaHobeututa(zerrendaOrdenatuta, 50000);
		t_bukaera = clock();
...
void arruntaHobeututa(int zerrenda[], int kopurua) {
	...
	for (i = 0; i < kopurua - 1; i++) {
		minpos = i;
		for (j = i + 1; j < kopurua; j++) {

			if (zerrenda[j] < zerrenda[minpos]) {
				minpos = j;
			}

		}
		aux = zerrenda[minpos];
		zerrenda[minpos] = zerrenda[i];
		zerrenda[i] = aux;
	}
