...
void burbuila(int zerrenda[], int kopurua);
...
int main() {
	...
	if (n == 1) {
		...
		t_hasiera = clock();
		burbuila(zerrendaOrdenatuta, 30000);
		t_bukaera = clock();
		...
		t_hasiera = clock();
		burbuila(zerrendaOrdenatuta, 50000);
		t_bukaera = clock();
