...
void burbuila_hobetuta(int zerrenda[], int kopurua);
...
int main() {
	...
	if (n == 1) {
		...
		//---------------denbora neurtu--------------
		t_hasiera = clock();
		burbuila_hobetuta(zerrenda, kopurua);
		t_bukaera = clock();
		...
		t_hasiera = clock();
		burbuila_hobetuta(zerrendaOrdenatuta, 30000);
		t_bukaera = clock();
		...
		t_hasiera = clock();
		burbuila_hobetuta(zerrenda5, kopurua);
		t_bukaera = clock();
		...
		t_hasiera = clock();
		burbuila_hobetuta(zerrendaOrdenatuta, 50000);
		t_bukaera = clock();
